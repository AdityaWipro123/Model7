...
model = joblib.load("./model7_fin.pkl")
...
input_headers = [
    "Pressure", "Bore", "Rod diameter", "Stroke","CEC_Thickness","HEC-OD","HEC_Thickness"
]
...
if st.button("Predict Cost 💰"):
    ...
    input_data = pd.DataFrame([[
        pressure, bore, rod_dia, stroke,cec_thickness,hec_od,hec_thickness
    ]], columns=input_headers)
